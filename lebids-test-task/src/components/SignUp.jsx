...
const AppSignUp = () => {
   ...
   const [redirectApprove, setRedirectApprove] = useState(false);
   ...
   const onLoading = (data) => {
      reg(JSON.stringify(data, ['password', "username", "displayName"], 2))
         .then(value => value ? setRedirectStatus(true) : null)
   }
   ...
   const redirect = redirectApprove ? <Navigate to="/" replace={true} /> : null;
